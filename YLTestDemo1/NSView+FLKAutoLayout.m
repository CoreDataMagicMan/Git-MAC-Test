...
typedef NSArray* (^viewChainingBlock)(FLK_VIEW* view1, FLK_VIEW* view2);


@implementation FLK_VIEW (FLKAutoLayout)


#pragma mark Generic constraint methods for two views

- (NSArray*)alignAttribute:(NSLayoutAttribute)attribute toView:(FLK_VIEW*)view predicate:(NSString*)predicate {
    NSArray* views = view ? @[view] : nil;
    return [FLK_VIEW alignAttribute:attribute ofViews:@[self] toViews:views predicate:predicate];
}

- (NSArray*)alignAttribute:(NSLayoutAttribute)attribute toAttribute:(NSLayoutAttribute)toAttribute ofView:(FLK_VIEW*)view predicate:(NSString*)predicate {
    NSArray* views = view ? @[view] : nil;
    return [FLK_VIEW alignAttribute:attribute ofViews:@[self] toAttribute:toAttribute ofViews:views predicate:predicate];
}


#pragma mark Constrain multiple edges of two views

- (NSArray*)alignToView:(FLK_VIEW*)view {
    return [self alignTop:@"0" leading:@"0" bottom:@"0" trailing:@"0" toView:view];
}

- (NSArray*)alignTop:(NSString*)top bottom:(NSString*)bottom toView:(FLK_VIEW*)view {
...
- (NSArray*)alignLeading:(NSString*)leading trailing:(NSString*)trailing toView:(FLK_VIEW*)view {
...
- (NSArray*)alignTop:(NSString*)top leading:(NSString*)leading bottom:(NSString*)bottom trailing:(NSString*)trailing toView:(FLK_VIEW*)view {
...
- (NSArray*)alignTop:(NSString*)top leading:(NSString*)leading toView:(FLK_VIEW*)view {
    NSArray* topConstraints = [self alignTopEdgeWithView:view predicate:top];
    NSArray* leadingConstraints = [self alignLeadingEdgeWithView:view predicate:leading];
    return [topConstraints arrayByAddingObjectsFromArray:leadingConstraints];
}

- (NSArray*)alignBottom:(NSString*)bottom trailing:(NSString*)trailing toView:(FLK_VIEW*)view {
    NSArray* bottomConstraints = [self alignBottomEdgeWithView:view predicate:bottom];
    NSArray* trailingConstraints = [self alignTrailingEdgeWithView:view predicate:trailing];
...
- (NSArray*)constrainWidthToView:(FLK_VIEW*)view predicate:(NSString*)predicate {
    return [self alignAttribute:NSLayoutAttributeWidth toView:view predicate:predicate];
}

- (NSArray*)constrainHeightToView:(FLK_VIEW*)view predicate:(NSString*)predicate {
...
- (NSArray*)constrainLeadingSpaceToView:(FLK_VIEW*)view predicate:(NSString*)predicate {
...
-(NSArray *)constrainTrailingSpaceToView:(FLK_VIEW *)view predicate:(NSString *)predicate {
...
- (NSArray*)constrainTopSpaceToView:(FLK_VIEW*)view predicate:(NSString*)predicate {
    return [self alignAttribute:NSLayoutAttributeTop toAttribute:NSLayoutAttributeBottom ofView:view predicate:predicate];
}

- (NSArray*)constrainBottomSpaceToView:(FLK_VIEW*)view predicate:(NSString*)predicate {
...
+ (NSArray*)alignLeadingEdgesOfViews:(NSArray*)views {
    return [self chainViews:views usingBlock:^NSArray*(FLK_VIEW* view1, FLK_VIEW* view2) {
...
+ (NSArray*)distributeCenterXOfViews:(NSArray*)views inView:(FLK_VIEW*)inView {
    return [self distributeAttribute:NSLayoutAttributeCenterX OfViews:views inView:inView];
}

+ (NSArray*)distributeCenterYOfViews:(NSArray*)views inView:(FLK_VIEW*)inView {
    return [self distributeAttribute:NSLayoutAttributeCenterY OfViews:views inView:inView];
}

+ (NSArray*)distributeAttribute:(NSLayoutAttribute)attribute OfViews:(NSArray*)views inView:(FLK_VIEW*)inView {
